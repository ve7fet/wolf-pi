...
Alternatively, an enclosure has been designed in FreeCad, with the .stl files available. Confirmed working for the v1.2 board, printed in PLA. Uses #4-40 hardware.
